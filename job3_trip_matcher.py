...
kafka_props = {
    ...
    'auto.offset.reset': 'earliest' # Use earliest to prevent skipping missed events on restarts
}
...
kafka_sink = FlinkKafkaProducer("processed.trips", SimpleStringSchema(), producer_config={"bootstrap.servers": "127.0.0.1:9094", "transaction.timeout.ms": "900000"})
matched_trips_json.add_sink(kafka_sink)
